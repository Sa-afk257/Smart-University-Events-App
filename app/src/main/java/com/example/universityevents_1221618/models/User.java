...
public class User {
    ...
    public User(int id, String email, String firstName, String lastName, String password, String gender, String country, String city, String phone, String profilePicUri, String role) {
        this.id = id;
        this.email = email;
